...
def COVID19_Predictor():
 ...
 if selected_dataset == 'Dataset1':
    df1 = pd.read_excel (r'C:\Users\asus\OneDrive - International Islamic University Malaysia\NORSYAHIDAH\SyahidZul\Master2021\Data Collection\Data_Covid19_MalaysiaGeneral (first-third wave).xlsx') 
    covid_history = df1 
 ...
 if selected_dataset == 'Dataset2':
    df2 = pd.read_excel (r'C:\Users\asus\OneDrive - International Islamic University Malaysia\NORSYAHIDAH\SyahidZul\Master2021\Data Collection\Data_Covid19_MalaysiaGeneral.xlsx') 
    covid_history = df2         
    #initial condition and initial values of parameters
    #initN (Malaysian Population 2020- include non citizen)
    initN = 32657300
